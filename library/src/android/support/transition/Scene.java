...
public final class Scene {
     ...
     * by {@link android.transition.TransitionManager} XML resource files.
     *
     ...
     * use one of the methods in {@link android.transition.TransitionManager} instead.
     */
    public void enter() {
    ...
    static void setCurrentScene(View view, Scene scene) {
        view.setTag(com.guerwan.transitionsbackport.R.id.current_scene, scene);
    }
    ...
    static Scene getCurrentScene(View view) {
        return (Scene) view.getTag(com.guerwan.transitionsbackport.R.id.current_scene);
    }
     ...
     * used by {@link android.transition.Fade} to fade these views out (the views must be removed from
